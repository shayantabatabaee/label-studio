...
class ImportStorage(Storage):
    ...
    @classmethod
    def add_task(cls, data, project, maximum_annotations, max_inner_id, storage, key, link_class, unique_id):
        # predictions
    ...
    def _scan_and_create_links(self, link_class):
        ...
        for key in self.iterkeys():
            ...
            self.add_task(data, self.project, maximum_annotations, max_inner_id, self, key, link_class, unique_id)
